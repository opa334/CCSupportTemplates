...
@property (nonatomic,weak) id<CCUILayoutViewLayoutSource> layoutSource;			//@synthesize layoutSource=_layoutSource - In the implementation block
- (void)setNeedsLayout;
- (void)layoutSubviews;
...
- (instancetype)initWithFrame:(CGRect)arg1 layoutOptions:(id)arg2;
