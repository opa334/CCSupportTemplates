...
@property (nonatomic,readonly) NSUInteger moduleRowCount;
@property (nonatomic,weak) id<CCUIModularControlCenterViewControllerDelegate> delegate;			//@synthesize delegate=_delegate - In the implementation block
