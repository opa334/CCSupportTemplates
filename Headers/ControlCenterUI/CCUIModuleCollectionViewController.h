...
@property (nonatomic,readonly) NSUInteger expandedModuleCount;
@property (nonatomic,retain) CCUIModuleCollectionView * moduleCollectionView;
@property (nonatomic,weak) id<CCUIModuleCollectionViewControllerDelegate> delegate;		//@synthesize delegate=_delegate - In the implementation block
...
- (id)_positionProviderForInterfaceOrientation:(NSInteger)arg1;
...
- (id)_sizesForModuleIdentifiers:(id)arg1 moduleInstanceByIdentifier:(id)arg2 interfaceOrientation:(NSInteger)arg3;
...
- (instancetype)initWithModuleInstanceManager:(id)arg1;
- (NSUInteger)expandedModuleCount;
